...
***Ejercicio 1***-:one:Mostrar la población de alemania
```SQL
SELECT population
FROM world
WHERE name ='GERMANY';
```
***Ejercicio 2***-:two:Mostrar el nombre y la población de 'Noruega' 'Suecia' y 'Dinamarca'
```SQL
...
OR name = 'Denmark' ;
```
***Ejercicio 3***-:three:Mostrar el país y el área para países con un área entre 200,000 y 250,000.
```SQL
